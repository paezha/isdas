...
4) The residuals have constant variance: $Var[\epsilon_i|X] = \sigma^2$ $\forall i$.

5) The residuals are independent, that is, they are not correlated among them: $E[\epsilon_i\epsilon_j|X] = 0$ $\forall i\neq j$
...
htmlwidgets::saveWidget(widget = map1, 
                        file = "map1.html")
webshot2::webshot(url = "map1.html", 
                  file = "map1.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = scp1, 
                        file = "scp1.html")
webshot2::webshot(url = "scp1.html", 
                  file = "scp1.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
lmp <- localmoran.map(Hamilton_CT, 
               Hamilton_CT.w, 
               "POP_DENSITY", 
               by = "TRACT")
...
1. $ln(P_i)= (\beta_0 + \beta_2) + (\beta_1 + \beta_2)x_i + \epsilon_i$ if census tract $i$ is in the CBD};
1. $ln(P_i)= (\beta_0 + \beta_3) + (\beta_1 + \beta_5)x_i + \epsilon_i$ if census tract $i$ is in the Suburbs; and
1. $ln(P_i)= \beta_0  + \beta_1x_i + \epsilon_i$ otherwise}.
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = map2, 
                        file = "map2.html")
webshot2::webshot(url = "map2.html", 
                  file = "map2.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
