...
# The first plot is Moran's scatterplot
  scp <- plot_ly(df_msc.sd) |> # Create a `plotly` object using the dataframe as an input. The pipe operator passes this object to the function `add_markers()`; this function is similar to the `geom_point()` function in `ggplot2` and it draws objects on the blank plot created by `plot_ly()`
...
# The second plot is a choropleth map
  map <- plot_ly(df_msc.sd) |> # Create a `plotly` object using the dataframe as an input. The pipe operator passes this object to the function `add_sf()`; this function is similar to the `geom_sf()` functions in `ggplot2` and it draws a simple features object on the blank plot created by `plot_ly()`
...
htmlwidgets::saveWidget(widget = scp, 
                        file = "scp.html")
webshot2::webshot(url = "scp.html", 
                  file = "scp.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
lmp <- localmoran.map(Hamilton_CT, Hamilton_CT.w, 
               "POP_DENSITY", 
               by = "TRACT")
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = lmp, 
                        file = "lmp.html")
webshot2::webshot(url = "lmp.html", 
                  file = "lmp.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = cp1, 
                        file = "cp1.html")
webshot2::webshot(url = "cp1.html", 
                  file = "cp1.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = cp2, 
                        file = "cp2.html")
webshot2::webshot(url = "cp2.html", 
                  file = "cp2.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
$w_{ij} = 1$ if $d_{ij}\leq d$ and $w_{ij} = 0$ otherwise}.
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = cp3, 
                        file = "cp3.html")
webshot2::webshot(url = "cp3.html", 
                  file = "cp3.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = cp4, 
                        file = "cp4.html")
webshot2::webshot(url = "cp4.html", 
                  file = "cp4.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
