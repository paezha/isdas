---
title: "03 Chapter: Introduction to Mapping in `R`"
author: 
- name: Antonio Páez
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = m_test, 
                        file = "m_test.html")
webshot2::webshot(url = "m_test.html", 
                  file = "m_test.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = m2, 
                        file = "m2.html")
webshot2::webshot(url = "m2.html", 
                  file = "m2.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = m2_test, 
                        file = "m2_test.html")
webshot2::webshot(url = "m2_test.html", 
                  file = "m2_test.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
