...
1\textrm{ if } A_i \textrm{ and } A_j \textrm{ share an edge}\\
0\textrm{ otherwise}\\
\end{array}
$$
...
$$
w_{ij}=\bigg\{\begin{array}{l l}
1\textrm{ if } A_i \textrm{ and } A_j \textrm{ share an edge or a vertex}\\
0\textrm{ otherwise}\\
\end{array}
$$
...
$$
\textrm{The total number of neighbors of } A_i \textrm{ is given by: }\sum_{j=1}^{n}{w_{ij}}
$$
...
$$
w_{ij}=\bigg\{\begin{array}{l l}
1\textrm{ if inter-centroid distance } d_{ij}\leq \delta\\
0\textrm{ otherwise}\\
\end{array}
$$
...
$$
w_{ij}=\bigg\{\begin{array}{l l}
1\textrm{ if } A_j \textrm{ is one of } k\textrm{-nearest neighbors of } A_i\\
0\textrm{ otherwise}\\
\end{array}
$$
