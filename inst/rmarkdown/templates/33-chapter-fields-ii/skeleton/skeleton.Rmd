...
With $w_{pi} = 1$ if $i$ is one of $k$-th nearest neighbors of $p$ for a given $k$, and $w_{pi} = 0$ otherwise.
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = trend.plot, 
                        file = "trend.plot.html")
webshot2::webshot(url = "trend.plot.html", 
                  file = "trend.plot.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = WL.plot2, 
                        file = "WL.plot2.html")
webshot2::webshot(url = "WL.plot2.html", 
                  file = "WL.plot2.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = WL.plot3, 
                        file = "WL.plot3.html")
webshot2::webshot(url = "WL.plot3.html", 
                  file = "WL.plot3.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
...
# This code takes a screen capture of the figure to include it in the 
# pdf file when knitting
htmlwidgets::saveWidget(widget = WL.plot4, 
                        file = "WL.plot4.html")
webshot2::webshot(url = "WL.plot4.html", 
                  file = "WL.plot4.png", 
                  delay = 1, 
                  zoom = 4, 
                  vheight = 500)
